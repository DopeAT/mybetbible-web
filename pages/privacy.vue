  ...
  <div>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          Agreement) refers to Mybetbible.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Mybetbible, accessible from
          <a href="https://www.mybetbible.com/" rel="external nofollow noopener" target="_blank"
            >https://www.mybetbible.com/</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        ...
        <a
          href="https://www.mybetbible.com/about-us"
          rel="external nofollow noopener"
          target="_blank"
          >https://www.mybetbible.com/about-us</a
        >
      </li>
    </ul>
  </div>
