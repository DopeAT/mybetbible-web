...
<template>
  <div class="page-title p-3">
    <h2 class="text-3xl"><strong>Terms and Conditions</strong></h2>
    <p>Welcome to mybetbible!</p>
    <p>
      These terms and conditions outline the rules and regulations for the use of mybetbible's
      Website, located at https://www.mybetbible.com/.
    </p>
    <p>
      By accessing this website we assume you accept these terms and conditions. Do not continue to
      use mybetbible if you do not agree to take all of the terms and conditions stated on this
      page.
    </p>
    <p>
    ...
    <p>
      We employ the use of cookies. By accessing mybetbible, you agreed to use cookies in agreement
      with the mybetbible's Privacy Policy.
    </p>
    <p>
    ...
    <p>
      Unless otherwise stated, mybetbible and/or its licensors own the intellectual property rights
      for all material on mybetbible. All intellectual property rights are reserved. You may access
      this from mybetbible for your own personal use subjected to restrictions set in these terms
      and conditions.
    </p>
    <p>You must not:</p>
    <ul>
      <li>Republish material from mybetbible</li>
      <li>Sell, rent or sub-license material from mybetbible</li>
      <li>Reproduce, duplicate or copy material from mybetbible</li>
      <li>Redistribute content from mybetbible</li>
    </ul>
    <p>
    ...
    <p>
      ...
      information in certain areas of the website. mybetbible does not filter, edit, publish or
      review Comments prior to their presence on the website. Comments do not reflect the views and
      opinions of mybetbible,its agents and/or affiliates. Comments reflect the views and opinions
      of the person who post their views and opinions. To the extent permitted by applicable laws,
      mybetbible shall not be liable for the Comments or for any liability, damages or expenses
      caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
      Comments on this website.
    </p>
    <p>
      mybetbible reserves the right to monitor all Comments and to remove any Comments which can be
    ...
    <p>
      You hereby grant mybetbible a non-exclusive license to use, reproduce, edit and authorize
    ...
    <p>
      ...
      visibility of the hyperlink compensates the absence of mybetbible; and (d) the link is in the
    ...
    <p>
      ...
      to our website, you must inform us by sending an e-mail to mybetbible. Please include your
    ...
    <p>
      No use of mybetbible's logo or other artwork will be allowed for linking absent a trademark
      license agreement.
    </p>
